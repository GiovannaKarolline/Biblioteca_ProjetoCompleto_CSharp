...
{
    /// <inheritdoc />
    public partial class CriandoOBancoDeDadosNovamente : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ObrasLiterarias", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ObrasLiterarias_Categorias_CategoriaId",
                        column: x => x.CategoriaId,
                        principalTable: "Categorias",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ObrasLiterarias_Editoras_EditoraId",
            ...
            migrationBuilder.CreateTable(
                name: "AutorObraLiteraria",
                columns: table => new
                {
                    AutoresId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ObrasLiterariasId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AutorObraLiteraria", x => new { x.AutoresId, x.ObrasLiterariasId });
                    table.ForeignKey(
                        name: "FK_AutorObraLiteraria_Autores_AutoresId",
                        column: x => x.AutoresId,
                        principalTable: "Autores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AutorObraLiteraria_ObrasLiterarias_ObrasLiterariasId",
                        column: x => x.ObrasLiterariasId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StatusDisponibilidade = table.Column<bool>(type: "bit", nullable: false),
                    Deletado = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "CopiaEmprestimo",
                columns: table => new
                {
                    CopiasId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    EmprestimosId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CopiaEmprestimo", x => new { x.CopiasId, x.EmprestimosId });
                    table.ForeignKey(
                        name: "FK_CopiaEmprestimo_Copias_CopiasId",
                        column: x => x.CopiasId,
                        principalTable: "Copias",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CopiaEmprestimo_Emprestimos_EmprestimosId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AutorObraLiteraria_ObrasLiterariasId",
                table: "AutorObraLiteraria",
                column: "ObrasLiterariasId");

            migrationBuilder.CreateIndex(
                name: "IX_CopiaEmprestimo_EmprestimosId",
                table: "CopiaEmprestimo",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ObrasLiterarias_CategoriaId",
                table: "ObrasLiterarias",
                column: "CategoriaId");

            migrationBuilder.CreateIndex(
                name: "IX_ObrasLiterarias_EditoraId",
                table: "ObrasLiterarias",
                column: "EditoraId");
        }
